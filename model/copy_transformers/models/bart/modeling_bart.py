...
BART_GENERATION_EXAMPLE = r"""
    Summarization example::
        ...
        >>> ARTICLE_TO_SUMMARIZE = "My friends are cool but they eat todo many carbs."
    ...
    Mask filling example::
        ...
        >>> TXT = "My friends are <mask> but they eat todo many carbs."
...
class BartEncoder(BartPretrainedModel):
    ...
    def forward(
        ...
        if pinyin_ids is not None:
            inputs_embeds += self.embed_tokens(pinyin_ids) * self.embed_scale
...
class BartDecoder(BartPretrainedModel):
    ...
    def forward(
        ...
        if decoder_pinyin_ids is not None:
            inputs_embeds += self.embed_tokens(decoder_pinyin_ids) * self.embed_scale
...
class BartModel(BartPretrainedModel):
    ...
    def forward(
        ...
        decoder_outputs = self.decoder(
            ...
            output_hidden_states=output_hidden_states,
            return_dict=return_dict,
            decoder_pinyin_ids=decoder_pinyin_ids,
        )
