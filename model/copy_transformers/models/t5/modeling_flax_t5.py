...
class FlaxT5PreTrainedModel(FlaxPreTrainedModel):
    ...
    def encode(
        ...
        Example::
            ...
            >>> text = "My friends are cool but they eat todo many carbs."
...
class FlaxT5ForConditionalGeneration(FlaxT5PreTrainedModel):
    ...
    def decode(
        ...
        Example::
            ...
            >>> text = "summarize: My friends are cool but they eat todo many carbs."
            >>> inputs = tokenizer(text, return_tensors='np')
            >>> encoder_outputs = model.encode(**inputs)
...
FLAX_T5_CONDITIONAL_GENERATION_DOCSTRING = """
    ...
    Example::
        ...
        >>> ARTICLE_TO_SUMMARIZE = "summarize: My friends are cool but they eat todo many carbs."
