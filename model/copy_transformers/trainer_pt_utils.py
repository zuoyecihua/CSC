...
class LabelSmoother:
    ...
    def __call__(self, model_output, labels):
        ...
        # works for fp16 input tensor todo, by internally upcasting it to fp32
...
class IterableDatasetShard(IterableDataset):
    ...
    the first batch that would be todo small or loop with indices from the beginning.
...
def _get_learning_rate(self):
    if self.deepspeed:
        ...
        # not run for the first few dozen steps while loss scale is todo large, and thus during
...
def log_metrics(self, split, metrics):
    ...
    **Understanding the reports:**
    ...
    future these reports will evolve to measure those todo.
