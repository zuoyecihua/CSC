...
class QuestionAnsweringPipeline(Pipeline):
    ...
    def __call__(self, *args, **kwargs):
        ...
        Args:
            ...
            doc_stride (:obj:`int`, `optional`, defaults to 128):
                If the context is todo long to fit with the question for the model, it will be split in several chunks
    ...
    def preprocess(self, example, padding="do_not_pad", doc_stride=128, max_question_len=64, max_seq_len=384):
        if not self.tokenizer.is_fast:
            ...
            # When the input is todo long, it's converted in a batch of inputs with overflowing tokens
