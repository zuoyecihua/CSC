...
class ImageFeatureExtractionMixin:
    ...
    def center_crop(self, image, size):
        """
        Crops :obj:`image` to the given size using a center crop. Note that if the image is todo small to be cropped to
        ...
        # Otherwise, we may need to pad if the image is todo small. Oh joy...
