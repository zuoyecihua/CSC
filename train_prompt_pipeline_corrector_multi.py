...
from trainers.train_pipeline_multi import TrainerPipelineCorrectorMulti
...
config_yaml = "test_csc_multi.yaml"
...
def main():
    ...
    trainer = TrainerPipelineCorrectorMulti(optimizer, train_loader, test_loader, model, args.train_paras, sacred_ex = ex)
    trainer.train()
